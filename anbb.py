...
def products_page():   
    ...
    all_products = [
    {"pid": "1", "name": "هودي 'دكتور'", "price": 69.99, "image":"https://images.cdn-files-a.com/uploads/6243106/400_65fc81a667676.png", "description": "هودي دكتور"},
    {"pid": "2", "name": "هودي 'المهندس'", "price": 69.99, "image": "https://files.cdn-files-a.com/uploads/6243106/400_66843b0e55998.jpg", "description": "هودي المهندس"},
    {"pid": "3", "name": "هودي 'بتضلي أنتِ العنوان'", "price": 49.99, "old_price": 80, "image":"https://images.cdn-files-a.com/uploads/6243106/400_65fc4a8eba036.png", "description": "هودي العنوان"},
    {"pid": "4", "name": "هودي 'معادلة التوجيهي'", "price": 49.99, "old_price": 80, "image":"https://images.cdn-files-a.com/uploads/6243106/400_65fc493bd98f0.png", "description": "هودي توجيهي"},
    {"pid": "5", "name": "هودي 'الحياة مشوار'", "price": 59.99, "old_price": 80, "image":"https://files.cdn-files-a.com/uploads/6243106/400_66843c98479db.jpg", "description": "هودي الحياة"},
    {"pid": "6", "name": "هودي 'Why always me'", "price": 69.99,"image":"https://images.cdn-files-a.com/uploads/6243106/400_65fc7dd71fcb5.png", "description": "هودي why"},
    {"pid": "7", "name": "هودي 'أنا ما زلت على قيد الحياة'", "price": 59.99, "image":"https://images.cdn-files-a.com/uploads/6243106/400_65fc7e7a28d72.png", "description": "هودي الحياة"},
    {"pid": "8", "name": "هودي 'أنا عزيز الروح'", "price": 49.99, "old_price": 80, "image": "https://images.cdn-files-a.com/uploads/6243106/400_65fc7c8e1646b.png", "description": "هودي عزيز الروح"},
    {"pid": "9", "name": "هودي 'فلسطين مزروعة بالقلب'", "price": 59.99, "image":"https://images.cdn-files-a.com/uploads/6243106/400_65fc42a07fbf4.png" , "description": "هودي فلسطين"},
    {"pid": "10", "name": "هودي 'الأمور تحت السيطرة'", "price": 59.99, "old_price": 80, "image":"https://images.cdn-files-a.com/uploads/6243106/400_65fc7c4862ef1.png", "description": "هودي السيطرة"},
    {"pid": "11", "name": "توم & جيري", "price": 139.99, "image":"https://images.cdn-files-a.com/uploads/6243106/400_65fc7b5b607f9.png", "description": "هودي زوجي بتصميم توم وجيري"},
    {"pid": "12", "name": "تاريخ مميز باللاتيني", "price": 119.99,  "image":"https://files.cdn-files-a.com/uploads/6243106/400_66844047797b4.jpg", "description": "هودي تاريخ مميز"},
    {"pid": "13", "name": "لك جناح و لي جناح", "price": 129.99, "image":"https://files.cdn-files-a.com/uploads/6243106/400_66843f625e9e4.jpg", "description": "هودي جناح"},
    {"pid": "14", "name": "إلى متى يا لوز", "price":139.99, "image":"https://files.cdn-files-a.com/uploads/6243106/400_66843fcd06af6.jpg", "description": "هودي لوز"},
    {"pid": "15", "name": "القلب و التاريخ", "price": 129.99,"image": "https://images.cdn-files-a.com/uploads/6243106/400_65fc46647bcc2.png", "description": "هودي قلب"},
    {"pid": "16", "name": "تحقق ما كان بالأمس حلماً", "price": 49.99, "old_price": 70, "image":"https://files.cdn-files-a.com/uploads/6243106/400_6684418364991.jpg", "description": "هودي حلم"},
    {"pid": "17", "name": "cristiano", "price": 44.99, "old_price": 70, "image":"https://files.cdn-files-a.com/uploads/6243106/400_668441cae61ae.jpg", "description": "هودي كريستيانو"},
    {"pid": "18", "name": "درسنا لنعمرها", "price": 39.99, "old_price": 60, "image": "https://files.cdn-files-a.com/uploads/6243106/400_66a90c56065cd.jpg", "description": "هودي لنعمرها"},
    {"pid": "19", "name": "فكر خارج الصندوق", "price": 39.99, "old_price": 60, "image":"https://files.cdn-files-a.com/uploads/6243106/400_6684411d02014.jpg", "description": "هودي الصندوق"},
]
    print("Query:", query)
    ...
    if query:
        ...
        filtered_products = [p for p in all_products if query_lower in p["name"].lower()]
...
<script>
  window.addEventListener('scroll', function() {
    ...
    ''', pid=pid, query=query, section=section, products=filtered_products)
...
.arrow.left {
  left: 120px;  /* على يسار الصورة */
}

.arrow.right {
  right: 120px;  /* على يمين الصورة */
}

.image-wrapper {
  position: relative; /* مهم حتى تصبح الأسهم بوضع مطلق داخلها */
  width: 100%;
}
        img {
          width: 100%;
...
</html>''', pid=pid, query=query, products=filtered_products, section=section)
# صيفي 
...
def search():
    ...
    filtered = [p for p in products_data if query in p["name"].lower()] if query else []
...
def checkout():
    ...
    if request.method == 'POST':
        ...
        with open('orders.txt', 'a', encoding='utf-8') as f:
            ...
            f.write("المنتجات:\n")
            for item in cart:
                f.write(f"- {item['name']}، الحجم: {item.get('size', 'غير محدد')}، اللون: {item.get('color', 'غير محدد')}، الكمية: {item['quantity']}، السعر: {item['price']} شيكل\n")
        ...
        return render_template_string("""
              ...
              """, name=name, address=address, payment_method=payment_method, delivery_method=region, total=total, notes=notes)
...
def submit_order():
    ...
    for item in cart_items:
        ...
        total += subtotal
        order_details.append(f"- {item.get('name', 'منتج')}، الحجم {item.get('size', 'غير محدد')}، اللون {item.get('color', 'غير محدد')}، الكمية: {quantity}، السعر: {price} شيكل، المجموع الفرعي: {subtotal} شيكل")
...
##<body>
  ##<div class="container">
    ...
    ##</form>
    ##<a href="/login">لديك حساب؟ سجل الدخول</a>
  ##</div>
##</body>
##</html>
##'''
...
##<body>
  ##<div class="container">
    ...
    ##</form>
    ##<a href="/register">لا تملك حساب؟ أنشئ واحدًا</a>
  ##</div>
##</body>
##</html>
...
##<body>
  ##<div class="account-box">
    ...
    ##<a href="/">العودة للشراء </a>
  ##</div>
##</body>
##</html>
##'''
##@app.route('/profile')  # هذا الرابط المرتبط بأيقونة الحساب
##def profile():
    ##if 'user_id' in session:
      ##  return redirect('/account')  # إذا مسجل دخول → حسابه
    ##else:
  ##      return redirect('/login')    # إذا مش مسجل دخول → تسجيل دخول
...
##def home():
    ##if request.method == 'POST':
          ...
          ##  password = request.form.get('password')
            ...
            # هنا لازم تتحقق من صحة اسم المستخدم وكلمة المرور
            # مثلاً تأكد من وجودهم في قاعدة بيانات أو في قاموس ثابت
            # هذه مجرد مثال:
            ##users = {'user1': 'pass1', 'user2': 'pass2'}
          ##  if username in users and users[username] == password:
            ##    session['username'] = username  # حفظ اسم المستخدم في الجلسة
          ##      return redirect('/h')  # إعادة توجيه لنفس الصفحة أو صفحة أخرى

        ##    else:
      ##          error = "اسم المستخدم أو كلمة المرور غير صحيحة."

    # إذا كان المستخدم مسجل دخوله (داخل الجلسة)
...
##'''
##,error=error, logged_in=False, username=None)
##def get_db_connection():
    ##conn = sqlite3.connect('database.db')
  ##  conn.row_factory = sqlite3.Row
    ##return conn
...
##def account():
   ## if 'user_id' in session:
    ##    return f"<h1>أهلاً بك، {session['username']}!</h1><br><a href='/logout'>تسجيل الخروج</a>"
  ##  return redirect('/login')

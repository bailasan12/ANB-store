...
def show_header():
    ...
    <style>
        ...
        .navbar button {
            background-color: #8B0000; border: none; color: white;
        ...
        .navbar button:hover {
            background-color: #A52A2A; color: white; transform: scale(1.1);
        ...
        .feature:hover, .team-member:hover { transform: scale(1.05); box-shadow: 0 8px 20px rgba(0,0,0,0.3); }
    ...
    put_buttons([("🏠 الرئيسية", "home"), ("🤖 الذكاء الاصطناعي", "ai"), ("👥 فريق العمل", "team")],
                onclick=lambda x: go_app(x, new_window=False))
...
if __name__ == "__main__":
    start_server({"home": home, "ai": ai_page, "team": team_page}, port=5000, debug=True, host='0.0.0.0', cdn=False)
